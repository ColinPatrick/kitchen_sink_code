...
const states = 50;
// adds together 5 and 4, and assigning the result to the 'math' variable
math = 5 + 4;
// assigns values to the 'vegetables' array
let vegetables = ["green beans", "carrots", "broccoli", "potatoes", "corn"];
// assigns value to the 'pet' object
var pet = {
  name: 'Bo',
  breed: 'Golden Doodle'
}
...
// assigns the result of the 'getLength' function into the charCount variable
var charCount = getLength('Hello world!');
